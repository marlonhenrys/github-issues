...
module.exports = async params => {
    ...
    while (params.language.amount > params.count) {
        ...
        try {
            ...
            if (nodes.length) {
                const formattedNodes = format.list(nodes, params)

                await file.save(formattedNodes, params.filename)
                console.log(green, `\n+${formattedNodes.length} repositórios coletados`)

            } else {
                console.log(yellow, '\nNenhum repositório de interesse coletado.')
            }
            ...
            if (pageInfo.hasNextPage) {
                ...
                console.log(yellow, '\nNão há mais repositórios para coletar.')
    ...
    console.log(`\nColeta de repositórios ${params.language.name} finalizada!\n`)
}